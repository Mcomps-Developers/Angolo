                        ...
                        <div class="col-sm-6">
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height iq-mb-3">
                                ...
                                <div class="card-footer">
                                    <p class="card-text"><small class="text-muted">{{ $item->created_at->format('F j, Y') }}</small> | <small>{{ $item->views }} views</small> | <small><i class="fa fa-user"></i> {{ $item->author->name }}</small></p>
                                </div>
                            </div>
                        </div>
                    @endforeach
