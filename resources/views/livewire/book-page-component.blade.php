                                        ...
                                        <div class="p-0 iq-card-body">
                                            ...
                                            <div class="iq-social d-flex align-items-center">
                                                ...
                                                <ul class="p-0 mb-0 list-inline d-flex align-items-center">
                                                    <li>
                                                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}&quote=Check+out+this+amazing+content titled+{{ urlencode($content->title) }}%0AVisit+link+below+for+more+details:+{{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}"
                                                            class="mr-2 avatar-40 rounded-circle bg-primary facebook" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="https://twitter.com/intent/tweet?url={{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}&text=Check+out+this+amazing+content titled+{{ urlencode($content->title) }}%0AVisit+link+below+for+more+details:+{{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}&hashtags=Education,OnlineLearning,SkillDevelopment,LifelongLearning"
                                                            class="mr-2 avatar-40 rounded-circle bg-primary twitter" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="whatsapp://send?text=Check+out+this+amazing+content titled+{{ urlencode($content->title) }}%0AVisit+link+below+for+more+details:+{{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}"
                                                            class="mr-2 avatar-40 rounded-circle bg-success whatsapp" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                                                    </li>
                                                    <li>
                                                        <a href="https://www.instagram.com/?url={{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}&title=Check+out+this+amazing+content titled*+{{ urlencode($content->title) }}*%0AVisit+link+below+for+more+details:+{{ route('content.details', ['reference' => $content->reference, 'slug' => $content->slug]) }}"
