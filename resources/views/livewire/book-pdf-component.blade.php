					...
					<ul id="iq-sidebar-toggle" class="iq-menu">
						<li class="active active-menu">
	                        ...
	                        <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
	                           ...
	                           <li class="active"><a href="/book-pdf"><i class="ri-file-pdf-line"></i>Book Detail</a></li>
			...
			<div class="iq-navbar-custom">
				<nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     <h5 class="mb-0">Book PDF</h5>
                     <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                           <li class="breadcrumb-item active" aria-current="page">Book PDF</li>
                        </ul>
                     </nav>
                  </div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="iq-card book-detail">
							<div class="iq-card-body p-0">
								<iframe src="images/book/book.pdf"  style="width: 100%; height: 90vh;"></iframe>
							</div>
						</div>
					</div>
				</div>
