                       ...
                       <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                          <li class="elements active active-menu">
                             ...
                             <ul id="sub-menu" class="iq-submenu collapse show" data-parent="#ui-elements">
                                ...
                                <li class="active"><a href="/ui-images"><i class="las la-images"></i>Images</a></li>
              ...
              <div class="row">
                 <div class="col-sm-12 col-lg-6">
                    ...
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          ...
                          <div class="media">
                             <img src="images/page-img/15.jpg" class="mr-3 avatar-80" alt="#">
                          ...
                          <div class="media">
                             <img src="images/page-img/16.jpg" class="mr-3 avatar-80" alt="#">
                             <div class="media-body">
                                <h5 class="mt-0">Media heading</h5>
                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                <div class="media mt-3">
                                   <a class="mr-3" href="#">
                                   <img src="images/page-img/17.jpg" class="avatar-80" alt="#">
                                   </a>
                                   <div class="media-body">
                                      <h5 class="mt-0">Media heading</h5>
                                      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                    ...
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          ...
                          <div class="media mb-5">
                             ...
                             <img src="images/page-img/18.jpg" class="ml-3 avatar-80" alt="#">
                          </div>
                          <div class="media mb-5">
                             <div class="media-body">
                             ...
                             <img src="images/page-img/19.jpg" class="align-self-center avatar-80 mr-3" alt="#">
                          </div>
                          <div class="media">
                             <div class="media-body">
                             ...
                             <img src="images/page-img/20.jpg" class="align-self-end avatar-80 mr-3" alt="#">
                          </div>
                       </div>
                    </div>
                 </div>
                 <div class="col-sm-12 col-lg-6">
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          <p>In addition to our <a href="https://templates.iqonic.design/docs/4.3/utilities/borders/">border-radius utilities</a>, you can use <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.</p>
                    ...
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          ...
                          <div class="media mb-4">
                             <img src="images/page-img/21.jpg" class="align-self-start avatar-80 mr-3" alt="#">
                             <div class="media-body">
                          ...
                          <div class="media mb-4">
                             <img src="images/page-img/22.jpg" class="align-self-center avatar-80 mr-3" alt="#">
                             <div class="media-body">
                          ...
                          <div class="media">
                             <img src="images/page-img/23.jpg" class="align-self-end avatar-80 mr-3" alt="#">
                             <div class="media-body">
                    ...
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          ...
                          <ul class="list-unstyled">
                             <li class="media">
                                <img src="images/page-img/24.jpg" class="mr-3 avatar-80" alt="#">
                                <div class="media-body">
