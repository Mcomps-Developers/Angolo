                       ...
                       <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                          <li class="elements active active-menu">
                             ...
                             <ul id="sub-menu" class="iq-submenu collapse show" data-parent="#ui-elements">
                                ...
                                <li class="active"><a href="/ui-media-object"><i class="las la-ad"></i>Media</a></li>
                    ...
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          ...
                          <div class="media mb-5">
                             ...
                             <img src="images/page-img/19.jpg" class="align-self-center mr-3 avatar-80" alt="#">
                          </div>
                          <div class="media">
                             <div class="media-body">
                             ...
                             <img src="images/page-img/20.jpg" class="align-self-end mr-3 avatar-80" alt="#">
                          </div>
                       </div>
                    </div>
                 </div>
                 <div class="col-sm-12 col-lg-6">
                    <div class="iq-card">
                       ...
                       <div class="iq-card-body">
                          ...
                          <div class="media mb-4">
                             <img src="images/page-img/22.jpg" class="align-self-center rounded avatar-80 mr-3" alt="#">
                             <div class="media-body">
                          ...
                          <div class="media">
                             <img src="images/page-img/23.jpg" class="align-self-end rounded avatar-80 mr-3" alt="#">
                             <div class="media-body">
